            ...
            <div className="max-w-4xl bg-gray-800 bg-opacity-80 rounded-lg shadow-md p-8 flex">
                <div className="bg-blue-500 bg-opacity-80 rounded-lg p-8 flex-shrink-0 w-1/3">
                    ...
                    <div className="text-white space-y-6">
                        ...
                        <div>
                            <div className="flex items-center mb-2">
                                <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 10h2a2 2 0 002-2V7a2 2 0 012-2h2a2 2 0 012 2v1a2 2 0 002 2h2a2 2 0 012 2v2a2 2 0 002 2h2m-2 2a2 2 0 01-2-2m0-6V7a2 2 0 00-2-2h-2a2 2 0 00-2 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v2a2 2 0 002 2m4 2h4m-2-2h2m4 0v2a2 2 0 002 2h2"></path></svg>
                                <span className="ml-2 text-lg">Address</span>
                            </div>
                            <p className="text-lg">602, Galleria Market</p>
                        </div>
                        <div>
                            <div className="flex items-center mb-2">
